...
export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.228a4.5 4.5 0 00-1.897 1.13l-2.21 2.21a3 3 0 00-2.685 2.685a9.095 9.095 0 002.286 6.57M16.5 12.553a9.094 9.094 0 00-2.286 6.57m-4.386 0M14.25 12c0-2.028-1.616-3.666-3.63-3.666s-3.63 1.638-3.63 3.666m0 0a4.5 4.5 0 004.5 4.5m-4.5-4.5a4.5 4.5 0 01-4.5-4.5m0 4.5v-1.372c0-1.256.52-2.4 1.372-3.247m10.258 0c.852.847 1.372 1.99 1.372 3.247v1.372m0 0A4.5 4.5 0 0018 16.5m-4.5-4.5a4.5 4.5 0 00-4.5-4.5" />
  </svg>
);

export const SettingsIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15 0a7.5 7.5 0 1115 0m-15 0H3m15 0h1.5m-1.5-1.5l-1.5-1.5m0 0l-1.5-1.5m1.5 1.5l1.5-1.5m-1.5-1.5l-1.5 1.5m-7.5-1.5l-1.5-1.5m0 0l-1.5-1.5m1.5 1.5l1.5-1.5m-1.5-1.5l-1.5 1.5m-1.5-1.5l-1.5 1.5m0 0l-1.5 1.5m1.5-1.5l-1.5-1.5m-7.5-1.5l-1.5-1.5m0 0l-1.5-1.5m1.5 1.5l1.5-1.5m-1.5-1.5l1.5 1.5m-1.5-1.5l-1.5 1.5m0 0l-1.5 1.5m1.5-1.5l-1.5-1.5" />
  </svg>
);
